    ...
    def load_proxies(self) -> None:
        try:
            ...
            if self.proxies:
                ...
                self.log_colored("WARNING", "No proxies found in proxy_list.txt", Colors.WARNING)
                
        except FileNotFoundError:
            self.log_colored("WARNING", "proxy_list.txt not found. Running without proxies.", Colors.WARNING)
